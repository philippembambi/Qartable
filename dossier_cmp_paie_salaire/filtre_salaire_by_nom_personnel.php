...
{
  $id_personnel = $_GET['personnel'];
}

$requete=$db->prepare('SELECT*  FROM kartable_remuneration LEFT JOIN kartable_personnel
...
$requete->bindValue(':id_personnel', $id_personnel, PDO::PARAM_INT);
$requete->execute();
$data = $requete->fetch();
?>
<!DOCTYPE html>
...
<div data-role="header" data-theme="<?php echo $theme; ?>">
		<h1 style="font-size: 20px;">Bulletin de paie de <?php echo $data['noms_personel']; ?></span></h1>
  ...
  <a href="./kartable_print_pdf.php?action=print_payement_by_personnal&amp;id_personnel=<?php echo $id_personnel; ?>&amp;noms=<?php echo $data['noms_personel']; ?>" class="ui-btn ui-corner-all ui-shadow ui-btn-b ui-btn-icon-left ui-icon-action" style="width: 80px;">Imprimer</a>
