...
<!--Page index-->
<div data-role="page" class="jqm-demos ui-responsive-panel" data-theme="c" id="page1" data-title="Gestion de configuration">
<!--composant formulaire-->
<app-menu></app-menu>
<?php include("./dossier_menu/template_menu3.php"); ?>
            ...
            <span style="margin-left: 1%;"><img src="./images/logo.png" alt="" style="height: 60px;" id="photologo"></span>
                  ...
                  <div class="hero-text">
                        <div id="typed-strings">
                            ...
                            <a href="#" v-on:click="show = !show" class="ui-btn ui-icon-user ui-btn-icon-notext" style="float:right;margin-right: 2%;">Icon only</a>
                        </div>
                      </section>
                      ...
                      <div data-role="navbar">
                        <div data-role="header" class="nav-glyphish-example" data-theme="c">
                          ...
                          <ul>
                              ...
                              <li>
                                <button onclick="new_admin()" data-icon="user">Nouvel Admin</button></li> 
                              <li></li>
...
<iframe src="./Kartable_content/content.html" frameborder="0" style="height: 100%;width: 100%;" id="myframes" data-transition="flip" ></iframe>
    ...
    <div data-role="footer" data-position="fixed" data-theme="c">
      <div data-role="navbar">
        ...
        <li><a href="#" onclick="organigramme()">Organigramme</a></li>
          <li><a href="#" data-ajax="false" class="ui-btn-active ui-state-persist" onclick="graph()">index</a></li>
          <li><a href="#" data-ajax="false" onclick="show_bulletin()">Bulletin scolaire</a></li>
        </ul>
      </div>
...
myframe.src = "./Kartable_content/content.html";
}
...
function show_connected_admin()
{
 var myframe = document.getElementById('myframes');
// myframe = myframe.contentDocument || myframe.document;
myframe.src = "./connected_admin.php";
}
...
function new_admin()
{
 var myframe = document.getElementById('myframes');
// myframe = myframe.contentDocument || myframe.document;
myframe.src = "./kartable_new_admin.php";
}
...
function ouvrir_licence_produit()
{
 var myframe = document.getElementById('myframes');
// myframe = myframe.contentDocument || myframe.document;
myframe.src = "./send/licence_kartable.pdf";
}

function new_contrat()
{
 var myframe = document.getElementById('myframes');
// myframe = myframe.contentDocument || myframe.document;
myframe.src = "./kartable_new_contrat.php";
}

function historique_contrat()
{
 var myframe = document.getElementById('myframes');
// myframe = myframe.contentDocument || myframe.document;
myframe.src = "./cmp_contrat_story.php";
}

function recu_verouilles()
{
 var myframe = document.getElementById('myframes');
// myframe = myframe.contentDocument || myframe.document;
myframe.src = "./dossier_cmp_frais_scolaire/cmp_recus_verouilles.php";
}

function info_serveur()
{
 var myframe = document.getElementById('myframes');
// myframe = myframe.contentDocument || myframe.document;
myframe.src = "./cmp_server_info.php";
}

function attribuer_droit_access()
{
 var myframe = document.getElementById('myframes');
// myframe = myframe.contentDocument || myframe.document;
myframe.src = "./cmp_droit_access.php";
}
function supprimer_droit_access()
{
  var myframe = document.getElementById('myframes');
// myframe = myframe.contentDocument || myframe.document;
myframe.src = "./cmp_del_droit_acces.php";
}

function goto_gest_eleve()
{
  window.open("./ktb_gestion_eleve.php");
}
 </script>
