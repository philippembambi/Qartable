...
<app-menu></app-menu>
<?php include("./dossier_menu/menu_gestion_perso.php"); ?>
                      ...
                      <div data-role="navbar">
                        <div data-role="header" class="nav-glyphish-example" data-theme="c">
                          ...
                          <ul>
                              ...
                              <li>
                                <button data-icon="user" data-toggle="modal" data-target="#personnel">Formulaire du personnel</button></li> 
                              <li></li>
