...
<head>
    ...
    <title>Perception et Comptabilité</title>
...
<app-menu></app-menu>
<?php include("./template_menu4.php"); ?>
            ...
            <span style="margin-left: 1%;"><img src="./images/logo.png" alt="" style="height: 60px;" id="photologo"></span>
                  ...
                  <div class="hero-text">
                        <div id="typed-strings">
                              <h3>Perception et Comptabilité</h3>
                                </div>
                      ...
                      <div data-role="navbar">
                        <div data-role="header" class="nav-glyphish-example" data-theme="c">
                          ...
                          <ul>
                              ...
                              <li>
                                <button onclick="new_admin()" data-icon="grid">Bilan de l'école</button></li> 
                              <li></li>
...
{
 var myframe = document.getElementById('myframes');
myframe.src = "./cmp_paiement_frais.php";
}
function historique_frais()
{
 var myframe = document.getElementById('myframes');
myframe.src = "./cmp_paiement_story.php";
}

function afficher_recu()
{
 var myframe = document.getElementById('myframes');
myframe.src = "./cmp_print_recu_frais.php";
}
...
{
 var myframe = document.getElementById('myframes');
myframe.src = "./kartable_paie_salaire.php";
}

function show_payement_story()
{
 var myframe = document.getElementById('myframes');
myframe.src = "./cmp_paie_salaire_story.php";
}

function enregister_emprunt()
{
 var myframe = document.getElementById('myframes');
myframe.src = "./kartable_emprunt.php";
}

function histortique_emprunt()
{
 var myframe = document.getElementById('myframes');
myframe.src = "./cmp_emprunt_story.php";
}

function print_stats_fees()
{
 var myframe = document.getElementById('myframes');
myframe.src = "./kartable_stats_frais_scolaires.php";
}
