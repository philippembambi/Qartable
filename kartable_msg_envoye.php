...
$req=$db->prepare('SELECT titre_msg, date_msg, id_msg, contenu_msg, lu, kartable_admin.noms_admin  FROM messagerie_privee 
LEFT JOIN kartable_admin
ON messagerie_privee.id_expediteur = kartable_admin.id_admin 
WHERE messagerie_privee.id_expediteur = :id_admin ORDER BY id_msg DESC');
...
<div data-role="header" data-theme="a">
		<h1 style="color: #3388cc;font-weight: bold;font-size: 18px;">Messages envoyés</h1>
...
WHERE messagerie_privee.id_msg = :id_msg');
$query->bindValue(':id_msg', (int) $data['id_msg'], PDO::PARAM_INT);
$query->execute();
$data2 = $query->fetch();
...
<div class="blog-comments" style="margin-left: 3%;margin-right: 3%;">
							<div class="media">
								...
								<div class="media-body" style="width:100%;">
									<h5 class="media-heading"> Envoyé à 
                                   <a href="#"> <?php echo $data2['noms_admin']; ?></a>
                                </h5>
<hr>
                ...
                <hr>
                   <div class="date-reply" style="text-transform:uppercase;">
                   <strong>Statut: 
                <?php echo ($data['lu'] == "")?' ':'<b style="color: green;"> <i class="fa fa-eye"></i> lu</b>'; ?> </strong> 
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <a href="#">Supprimer</a>   
            </div>
...
<div class="blog-comments" style="margin-left: 3%;margin-right: 3%;">
							<div class="media">
								<div class="media-left">
                                <img src="images/user.png" class="rounded-circle img-responsive" alt="Avatar photo" style="background-color:rgb(248, 78, 78);">
                                </div>
								<div class="media-body" style="width:100%;">
									<h5 class="media-heading"> Envoyé à 
                                   <a href="#"> <?php echo $data2['noms_admin']; ?></a>
