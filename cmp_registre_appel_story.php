...
$jour_yesterday = date('d', time());
$hier = (int) $jour_yesterday - 1;
...
<div data-role="header" data-theme="<?php echo $theme; ?>">
		<h1 style="font-size: 20px;">Registre d'appel du <span style="color:#3388cc;"> <?php echo $date_hier;
 ?></span></h1>
...
WHERE kartable_registre_appel.date_pointage = :yesterday AND kartable_eleves.promotion_id = :promotion_id');
$req->bindValue(':yesterday', $date_hier, PDO::PARAM_STR);
...
echo "<th data-priority='1'>id eleve</th>
