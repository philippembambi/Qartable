...
<div data-role="header" data-theme="<?php echo $theme; ?>">
		<h1 style="font-size: 20px;">Ayant payé au moins  <?php echo '<a href="#">'.$montant.' $</a> en '.$classe_promo. ' '. $option_promo; ?></span></h1>
...
<!--  <a href="./kartable_print_pdf.php?action=print_fees_by_classe_montant&amp;id_classe=<?php // echo $id_classe; ?>&amp;montant=<?php// echo $montant;?>" class="ui-btn ui-corner-all ui-shadow ui-btn-b" style="width: 80px;">Imprimer</a>-->

<?php
$req=$db->prepare('SELECT*  FROM kartable_frais_scolaire LEFT JOIN kartable_eleves
ON kartable_frais_scolaire.id_eleve = kartable_eleves.id_eleve LEFT JOIN kartable_promotion
ON kartable_eleves.promotion_id = kartable_promotion.id_promotion 
WHERE (kartable_promotion.id_promotion = :id_classe AND kartable_frais_scolaire.montant >= :montant) AND erreur_signalee = ""');
...
<h4 style="text-align: center;font-weight; bold;">Les élèves ayant payé au moins  <?php echo '<a href="#">'.$montant.' $</a> en '.$classe_promo. ' '. $option_promo; ?></h4>
