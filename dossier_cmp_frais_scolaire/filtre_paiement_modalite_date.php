...
<div data-role="header" data-theme="<?php echo $theme; ?>">
		<h1 style="font-size: 22px;"> <?php echo $modalite; ?></h1>
    <h2> <a href="#"><?php echo $date1; ?></a> -- <a href="#"><?php echo $date2; ?></a> </span></h2>
		<a href="filtre_paiement_modalite.php?modalite=<?php echo $modalite; ?>" data-shadow="false" data-iconshadow="false" data-icon="carat-l" data-iconpos="notext">Back</a>
...
WHERE (kartable_frais_scolaire.date_paiement BETWEEN :date1 AND :date2) AND (kartable_frais_scolaire.modalite = :modalite) ');
$req->bindValue(':date1', $filtre_date1, PDO::PARAM_STR);
$req->bindValue(':date2', $filtre_date2, PDO::PARAM_STR);
$req->bindValue(':modalite', $modalite, PDO::PARAM_STR);
$req->execute();
...
<h4 style="text-align: center;font-weight; bold;">Paiement du <a href="#"><?php echo $date1; ?></a> au <a href="#"><?php echo $date2; ?> pour <?php echo $modalite; ?></b></h4>
