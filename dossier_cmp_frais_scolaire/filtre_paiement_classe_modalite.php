...
<div data-role="header" data-theme="<?php echo $theme; ?>">
		<h1 style="font-size: 20px;"><?php echo $modalite.' pour la '.$classe_promo. ' '.substr($option_promo, 0, 4); ?></span></h1>
...
ON kartable_frais_scolaire.id_eleve = kartable_eleves.id_eleve LEFT JOIN kartable_promotion
ON kartable_eleves.promotion_id = kartable_promotion.id_promotion 
WHERE (kartable_frais_scolaire.modalite = :modalite AND kartable_promotion.id_promotion = :id_promo) AND erreur_signalee = "" ');
...
<h4 style="text-align: center;font-weight; bold;">Historique des Frais scolaires en <b><?php echo $classe_promo. ' '. $option_promo; ?> pour <?php echo $modalite; ?></b></h4>
