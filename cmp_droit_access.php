...
<div data-role="header" data-theme="<?php echo $theme; ?>">
		<h1 style="color: white;font-weight: bold;font-size: 18px;">Attribuer un droit d'accès</h1>
...
<form action="kartable_moteur.php?action=attribuer_droit_access" method="post" name="formulaire">
...
<div role="main" class="ui-content" style="background-color:white;">
    <h2 class="ui-title" style="color: black;font-size: 18px;">Voulez-vous vraiment lui attribuer ce droit d'accès ?</h2>
<hr>
