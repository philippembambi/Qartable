...
<div data-role="header" data-theme="<?php echo $theme; ?>">
		<h1 style="font-size: 20px;">Paiement du <a href="#"><?php echo $date1; ?></a> au <a href="#"><?php echo $date2; ?></a></span></h1>
  ...
  <a href="#" onclick="PrintDiv();" class="ui-btn ui-corner-all ui-shadow ui-btn-b" style="width: 100px;">Imprimer</a>
...
WHERE (kartable_frais_scolaire.date_paiement BETWEEN :date1 AND :date2) AND erreur_signalee = "" ');
...
<?php include("./cmp_file_header.php"); ?>
          ...
          <h4 style="text-align: center;font-weight; bold;">Historique des Frais scolaires du <b><?php echo $date1; ?></b> au <b><?php echo $date2; ?></b></h4>
