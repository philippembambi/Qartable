...
<!--Page index-->
<div data-role="page" class="jqm-demos ui-responsive-panel" data-theme="c" id="page1" data-title="Ui-gestion Calculator">
<!--composant formulaire-->
<app-menu></app-menu>
<?php include("./dossier_menu/menu_gestion_cotes.php"); ?>
                      ...
                      <div data-role="navbar">
                        <div data-role="header" class="nav-glyphish-example" data-theme="c">
                          ...
                          <ul>
                              ...
                              <li>
                                <button onclick="" data-icon="grid">Historique globale</button></li> 
                              <li></li>
...
<iframe src="./iframe_index_content.php" frameborder="0" style="height: 100%;width: 100%;" id="myframes" data-transition="flip" ></iframe>
    ...
    <div data-role="footer" data-position="fixed" data-theme="c">
      <div data-role="navbar">
        <ul>
        <li><a href="#" onclick="">Calendrier scolaire</a></li>
          <li><a href="#" data-ajax="false" class="ui-btn-active ui-state-persist" onclick="">index</a></li>
...
function ouvrir_calculator()
{
 var myframe = document.getElementById('myframes');
// myframe = myframe.contentDocument || myframe.document;
myframe.src = "./CALCULATOR/";
}

function ouvrir_bulletins()
{
 var myframe = document.getElementById('myframes');
// myframe = myframe.contentDocument || myframe.document;
...
function ouvrir_grilles()
{
 var myframe = document.getElementById('myframes');
// myframe = myframe.contentDocument || myframe.document;
myframe.src = "./GRILLE_COTES/";
}
 </script>
